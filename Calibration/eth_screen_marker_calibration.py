...
class Eth_Screen_Marker_Calibration(Calibration_Plugin):
    ...
    def start(self):
        ...
        if self.g_pool.detection_mapping_mode == '3d':
            if self.mode == 'calibration':
                self.sites = [(0.0, 1.0), (0.5, 0.0), (1.0, 0.5), (0.5, 1.0), (0.0, 0.0), (0.0, 0.5), (1.0, 0.0), (1.0, 1.0), (0.5, 0.5), (0.25, 0.25), (0.75, 0.75), (0.75, 0.25), (0.25, 0.75)]
            else:
                self.sites = [(0.4, 0.2), (0.8, 0.4), (0.6, 0.8), (0.2, 0.6), (0.6, 0.2), (0.8, 0.6), (0.4, 0.8), (0.2, 0.4), (0.8, 0.2), (0.4, 0.4), (0.2, 0.8), (0.6, 0.6), (0.2, 0.2), (0.6, 0.4), (0.8, 0.8), (0.5, 0.5)]
        else:
            if self.mode == 'calibration':
